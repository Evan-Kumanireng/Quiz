...
echo '<span id="tcexam-desc">TCExam Mobile Friendly version is a fork of TCExam by <a href="https://evankumanireng2.blogspot.com">@evan</a>. This version fix several bug in original TCExam and add UI enhancement for public and admin area.</span><br/><hr/>'.K_NEWLINE;
...
echo '<li>[ID] Indonesian : Mr Ahmad Bardosono</li>'.K_NEWLINE;
